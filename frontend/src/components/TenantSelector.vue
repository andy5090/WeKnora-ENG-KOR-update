...
const selectTenant = (tenantId: number) => {
  // Find selected tenant information
...
const loadTenants = async (append = false) => {
  ...
  try {
    ...
    // If pure number, search as both tenant_id and keyword
    // This allows exact matching of tenant ID and fuzzy matching of tenants with numbers in name

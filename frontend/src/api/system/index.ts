...
export interface AgentConfig {
  ...
  available_tools?: ToolDefinition[]  // Included in GET response, not needed for POST/PUT
  available_placeholders?: PlaceholderDefinition[]  // Included in GET response, not needed for POST/PUT
}

export default {
  ...
  agent: {
    ...
    editor: {
      ...
      queryMissingInContext:
        "컨텍스트 템플릿에는 {{query}} 플레이스홀더가 포함되어야 합니다.",
      ...
      defaultContextTemplateHint:
        "다음 시스템 기본 컨텍스트 템플릿을 사용하려면 비워 두세요.",
      ...
      allKnowledgeBasesDesc:
        "에이전트은 모든 지식베이스에 액세스할 수 있습니다.",
    ...
    builtinInfo: {
      quickAnswer: {
        name: "빠른 Q&A",
        description:
          "지식베이스 기반의 RAG Q&A로 질문에 빠르고 정확하게 답변해 드립니다.",
      },
      smartReasoning: {
        name: "에이전트 추론",
        description:
          "ReAct 추론 프레임워크는 다단계 사고 및 도구 호출을 지원합니다.",
      },
      deepResearcher: {
        name: "심층 연구원",
        description:
  ...
  input: {
    ...
    customAgentNotReadyTooltip:
      "에이전트가 준비되지 않았습니다. 먼저 구성을 완료하세요.",
    customAgentNotReadyDetail:
      "에이전트가 준비되지 않았으며 다음을 구성해야 합니다: {reasons}",
    ...
    webSearchForcedByAgent:
      "현재 에이전트는 네트워크 검색을 활성화했으며 이를 끌 수 없습니다.",
  ...
  conversationSettings: {
    ...
    thresholds: {
      description:
        "검색 재현율과 재정렬의 임계값, TopK를 조정해 정확도와 성능의 균형을 맞춥니다",
    },
    maxRounds: {
      label: "히스토리 보존 횟수",
  ...
  organization: {
    ...
    deleteConfirm:
      "정말로 이 스페이스를 삭제하시겠습니까? 이 작업은 취소할 수 없습니다.",
    ...
    emptyDesc:
      "초대 코드를 사용하여 스페이스를 만들거나 기존 스페이스에 참여하세요.",
    all: "모두",
    createdByMe: "내가 생성한",
    joinedByMe: "내가 참여한",
    createdTag: "생성",
    ...
    settings: {
      ...
      myRoleDesc:
        "이 스페이스에서의 귀하의 역할은 귀하의 권한 범위를 결정합니다.",
      ...
      sharedAgentsDesc:
        "이 스페이스에 공유되었으며 대화에서 구성원이 사용할 수 있는 에이전트",
      sharedAgentsKbHint:
      ...
      noSharedAgentsTip:
        "관리자는 에이전트 설정에서 이 스페이스에 에이전트를 공유할 수 있습니다.",
      ...
      inviteMembers: "회원 초대",
      inviteMembersDesc:
        "초대 코드 또는 링크를 통해 다른 사람을 스페이스에 초대하세요.",
      inviteLink: "초대링크",
    ...
    editor: {
      ...
      descriptionTip:
        "회원들이 스페이스를 이해할 수 있도록 스페이스의 목적과 목표를 설명합니다.",
      ...
      viewAccess: "읽기 전용 권한",
      adminPerm1:
        "스페이스 설정, 구성원, 에이전트과의 지식베이스 공유를 관리하세요.",
      ...
      joinDesc:
        "초대 코드를 통해 기존 스페이스에 참여하고 지식베이스 및 에이전트에 액세스하세요.",
      joinIllustration:
        "스페이스 관리자가 제공한 초대 코드를 입력하여 참여하세요.",
      inviteCodeTip:
        "초대코드는 스페이스 관리자가 생성한 것이므로 관리자에게 문의하세요.",
    ...
    share: {
      ...
      modelShareDesc:
        "스페이스 구성원이 모델을 사용할 수 있도록 모델을 스페이스에 공유합니다.",
      agentShareDesc:

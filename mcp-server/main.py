...
def check_environment_variables():
    ...
    if not api_key:
        print(
            "Warning: It is recommended to set the WEKNORA_API_KEY environment variable"
        )
...
Examples:
  ...
  python main.py --check-only       # Only check environment, don't start server
...
Environment Variables:
  ...
  WEKNORA_API_KEY     WeKnora API key
    ...
    parser.add_argument(
        "--verbose", "-v", action="store_true", help="Enable verbose log output"
    )

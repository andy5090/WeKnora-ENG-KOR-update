...
- Enable entity and relationship extraction on the knowledge base settings page, and configure related content according to the prompts
...
Log in to `http://localhost:7474`, execute `match (n) return (n)` to view the generated knowledge graph.
